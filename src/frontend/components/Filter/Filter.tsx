...
function Filter() {
  ...
  const tagList = [
    ...new Set(
      notes.reduce((acc: string[], { tags }) => [...acc, ...tags], [])
    ),
  ];
          ...
          <li>
            <label className='radio'>
              <input
                ...
                checked={priority === PRIORITY_HIGH}
              />
          ...
          <li>
            <label className='radio'>
              <input
                ...
                checked={priority === PRIORITY_MEDIUM}
              />
